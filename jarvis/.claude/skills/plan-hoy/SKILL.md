...
Produce exactamente **tres** prioridades. No cuatro. No una lista de deseos.
...
Si una de las tres no pasa el filtro 1, di explícitamente por qué está ahí.
...
```markdown
---
titulo: Plan 2026-09-03
tipo: plan
fecha: 2026-09-03
tags: [plan, vantera]
---

# Plan — jueves 3 de septiembre
...
- "Terminado se ve así" debe ser verificable por alguien más. "Trabajar en
  ...
  sí.
- Si el día tiene menos de 1 hora libre, escribe **una** prioridad, no tres.
  Un plan honesto de una tarea vale más que tres que no se van a hacer.
