...
salen a `web/datos/motor.json` pero la página aún no las revela: esa es la capa
que se cobrará. El precio en vivo lo sirve `api/precio.js`, que guarda la clave
